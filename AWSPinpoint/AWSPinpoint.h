...
/*!
 Project version number for the AWSPinpoint framework.
 ...
 */
FOUNDATION_EXPORT double AWSPinpointVersionNumber DEPRECATED_MSG_ATTRIBUTE("Use AWSPinpointTargetingSDKVersion instead.");

/*!
 Project version string for the AWSPinpoint framework.
